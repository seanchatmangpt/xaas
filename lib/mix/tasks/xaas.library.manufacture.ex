...
defmodule Mix.Tasks.Xaas.Library.Manufacture do
  @moduledoc """
  Manufactures the Xaas.Library domain, resources (Book, Checkout, HoldRequest, Curation, RecommendationLog),
  and applies pure declarative Ash resource definitions grounded in Schema.org, BIBO, and PROV ontologies.
  ...
  @base_targets [
    ...
    %{
      order: 4,
      mix_task: "ash.gen.resource",
      target_module: "Xaas.Library.HoldRequest",
      domain_module: "Xaas.Library",
    ...
    %{
      order: 6,
      mix_task: "ash.gen.resource",
      target_module: "Xaas.Library.RecommendationLog",
      domain_module: "Xaas.Library",
...
"""
  ...
  defp run_core_phase(_yes?) do
    ...
    write_hold_request_resource()
    write_curation_resource()
    write_recommendation_log_resource()

    Mix.shell().info("==> Realized Xaas.Library Pure Ash Declarative Resources.")
  end
