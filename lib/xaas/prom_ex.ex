...
# ---
# in lib/xaas/prom_ex.ex

defmodule Xaas.PromEx do
  @moduledoc """
  ...
  def plugins do
    [
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: XaasWeb.Router, endpoint: XaasWeb.Endpoint},
      Plugins.Ecto,
  ...
  def dashboards do
    [
      ...
      {:xaas, "grafana_dashboards/infrastructure.json"}
    ]
  end
end
