defmodule Xaas.Governance.Validations.ApprovalGeofenceExceptionGrantRequiresApprover do
  @moduledoc """
  Real business rule for `Xaas.Governance.ApprovalGeofenceExceptionGrant`'s
  `:approve` action, matching platform-console's real maker-checker
  requirement on `POST /api/owner/geofence-policy`'s
  `geofence.exception.grant` approval workflow: a distinct, second
