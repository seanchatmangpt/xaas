defmodule Xaas.Governance.Validations.ApprovalVendorOffboardingAttestationIssueRequiresApprover do
  @moduledoc """
  Real business rule for
  `Xaas.Governance.ApprovalVendorOffboardingAttestationIssue`'s `:approve`
  action, matching platform-console's real maker-checker requirement on
  `POST /api/owner/vendor-offboarding`: a distinct, second owner-role
