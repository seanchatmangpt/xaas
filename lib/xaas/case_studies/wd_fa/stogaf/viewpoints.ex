defmodule Xaas.CaseStudies.WdFa.Stogaf.Viewpoints do
  ...
  @viewpoints [
    ...
    %{id: "architecture", view: "System / Space", concern: "canonical state projections authority and reuse"},
    %{id: "assessment", view: "WD Case Study 2 Deck", concern: "requirements tradeoffs evidence and delivery"}
  ]
