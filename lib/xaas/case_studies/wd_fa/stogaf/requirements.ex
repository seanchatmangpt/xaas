defmodule Xaas.CaseStudies.WdFa.Stogaf.Requirements do
  ...
  @requirements [
    %{id: "R-01", name: "ranked failure modes", block: "TriageAdmission", standing: "ALIVE_FIXTURE"},
    ...
    %{id: "R-09", name: "visible confidence basis", block: "MorningBriefView", standing: "ALIVE_FIXTURE"},
    %{id: "R-10", name: "human loop", block: "EngineerDisposition", standing: "ALIVE_FIXTURE"},
    %{id: "R-11", name: "known versus novel", block: "TriageAdmission", standing: "ALIVE_FIXTURE"},
    %{id: "R-12", name: "feedback and learning", block: "MachineExperience", standing: "ALIVE_FIXTURE"},
    %{id: "R-13", name: "MTTR and process measurement", block: "Evaluation", standing: "DESIGN"},
    %{id: "R-14", name: "security and governance", block: "Governance", standing: "PARTIAL_ALIVE"},
