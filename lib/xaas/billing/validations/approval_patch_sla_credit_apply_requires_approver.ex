defmodule Xaas.Billing.Validations.ApprovalPatchSlaCreditApplyRequiresApprover do
  @moduledoc """
  Real business rule for `Xaas.Billing.ApprovalPatchSlaCreditApply`'s `:approve`
  action: an approval must name a real approver, and a requester may not
  approve their own patch SLA credit application request (maker-checker -- same shape as
