defmodule Xaas.Operations.ApprovalK8sFaultRemediateSuggest do
  @moduledoc """
  Real maker-checker approval resource for k8s fault remediation suggestion requests. Was a
  ...
  `Xaas.Operations.Validations.ApprovalK8sFaultRemediateSuggestRequiresApprover` -- `approved_by` must
  ...
  policies do
    ...
    # (`ApprovalK8sFaultRemediateSuggestRequiresApprover`) rejecting a missing or
