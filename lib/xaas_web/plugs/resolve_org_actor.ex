defmodule XaasWeb.Plugs.ResolveOrgActor do
  @moduledoc """
  ...
  `XaasWeb.Plugs.RequireInternalApiToken`, a single shared
  ...
  `XaasWeb.ApiRouter` (an `AshJsonApi.Router` covering all 7 domains'
  ...
  defp path_segment_tenant_scoped?(conn) do
    ...
    # `pipe_through` BEFORE `forward "/api", XaasWeb.ApiRouter` strips
