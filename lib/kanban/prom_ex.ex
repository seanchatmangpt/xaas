...
# ---
# in lib/kanban/prom_ex.ex

defmodule Kanban.PromEx do
  @moduledoc """
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     defmodule KanbanWeb.Endpoint do
       ...
       plug PromEx.Plug, prom_ex_module: Kanban.PromEx
  ...
  def dashboards do
    [
      ...
      {:kanban, "grafana_dashboards/infrastructure.json"}
    ]
  end
end
