defmodule XaasWeb.InternalApiRouterTest do
  @moduledoc """
  Real Chicago-style test for the real AshJsonApi.Router forward
  (lib/xaas_web/internal_api_router.ex, mounted at /internal-api in
  XaasWeb.Router) -- the one internal-api route not covered by a
