defmodule XaasWeb.AutofdeLab.StatusLiveTest do
  @moduledoc """
  Real Chicago-style coverage for `XaasWeb.AutofdeLab.StatusLive`'s
  ...
  setup do
    ...
    # default `setup_sandbox` only checks out `Xaas.LegacyRepo`, so every real
