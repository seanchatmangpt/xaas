defmodule XaasWeb.ApprovalSlaCreditApplyControllerTest do
  @moduledoc """
  ...
  (via `XaasWeb.Plugs.ResolveOrgActor`, newly scoped to this route) that
  ...
  `XaasWeb.ApprovalTierDowngradeControllerTest`'s own cross-org test
