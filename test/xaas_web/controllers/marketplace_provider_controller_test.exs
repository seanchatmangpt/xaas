defmodule XaasWeb.MarketplaceProviderControllerTest do
  @moduledoc """
  ...
  gated by the real `XaasWeb.Plugs.RequireInternalApiToken` plug on the
  ...
  # XaasWeb.Plugs.ResolveOrgActor resolves the real X-Org-Id header
