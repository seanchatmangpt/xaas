defmodule Xaas.ActuationOcelUndoTest do
  ...
  setup do
    ...
    # bound port via ThousandIsland.listener_info/1), as
    # test/xaas_web/ocel_envelope_avatars_test.exs does since 58f37af: the
    # hash-derived port (42_777 + phash2(self(), 500)) raised :eaddrinuse in
    # the pinned full-suite run on a host shared with other `mix test` runs.
