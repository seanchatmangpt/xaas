# Xaas.Platform.RouteProjectsBackups
...
- module: `RouteProjectsBackups`
- domain: `Xaas.Platform`
- would generate via: `mix ash.gen.resource Xaas.Platform.RouteProjectsBackups --ignore-if-exists --default-actions read`
