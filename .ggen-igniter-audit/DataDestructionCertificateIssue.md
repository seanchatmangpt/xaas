...
- module: `DataDestructionCertificateIssue`
- domain: `Xaas.Governance`
- would generate via: `mix ash.gen.resource Xaas.Governance.DataDestructionCertificateIssue --ignore-if-exists --default-actions read`
