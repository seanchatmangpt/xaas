...
- module: `ApprovalK8sFaultRemediateSuggest`
- domain: `Xaas.Operations`
- would generate via: `mix ash.gen.resource Xaas.Operations.ApprovalK8sFaultRemediateSuggest --ignore-if-exists --default-actions read`
