...
- module: `ApprovalSsoRoleMappingUpdate`
- domain: `Xaas.Governance`
- would generate via: `mix ash.gen.resource Xaas.Governance.ApprovalSsoRoleMappingUpdate --ignore-if-exists --default-actions read`
