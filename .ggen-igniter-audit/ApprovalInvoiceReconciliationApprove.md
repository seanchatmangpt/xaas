...
- module: `ApprovalInvoiceReconciliationApprove`
- domain: `Xaas.Billing`
- would generate via: `mix ash.gen.resource Xaas.Billing.ApprovalInvoiceReconciliationApprove --ignore-if-exists --default-actions read`
