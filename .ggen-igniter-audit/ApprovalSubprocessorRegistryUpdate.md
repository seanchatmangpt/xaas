...
- module: `ApprovalSubprocessorRegistryUpdate`
- domain: `Xaas.Governance`
- would generate via: `mix ash.gen.resource Xaas.Governance.ApprovalSubprocessorRegistryUpdate --ignore-if-exists --default-actions read`
