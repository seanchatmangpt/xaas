...
- module: `ApprovalComplianceRotationBlock`
- domain: `Xaas.Governance`
- would generate via: `mix ash.gen.resource Xaas.Governance.ApprovalComplianceRotationBlock --ignore-if-exists --default-actions read`
