...
- module: `ApprovalDeniedPartyOverride`
- domain: `Xaas.Governance`
- would generate via: `mix ash.gen.resource Xaas.Governance.ApprovalDeniedPartyOverride --ignore-if-exists --default-actions read`
