...
- module: `ApprovalInsurancePolicyUpdate`
- domain: `Xaas.Governance`
- would generate via: `mix ash.gen.resource Xaas.Governance.ApprovalInsurancePolicyUpdate --ignore-if-exists --default-actions read`
