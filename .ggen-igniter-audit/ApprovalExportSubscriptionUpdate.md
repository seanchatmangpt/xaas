...
- module: `ApprovalExportSubscriptionUpdate`
- domain: `Xaas.Governance`
- would generate via: `mix ash.gen.resource Xaas.Governance.ApprovalExportSubscriptionUpdate --ignore-if-exists --default-actions read`
