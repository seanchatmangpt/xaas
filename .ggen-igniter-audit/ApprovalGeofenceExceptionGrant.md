...
- module: `ApprovalGeofenceExceptionGrant`
- domain: `Xaas.Governance`
- would generate via: `mix ash.gen.resource Xaas.Governance.ApprovalGeofenceExceptionGrant --ignore-if-exists --default-actions read`
