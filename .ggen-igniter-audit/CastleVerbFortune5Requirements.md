...
- module: `CastleVerbFortune5Requirements`
- domain: `Xaas.Operations`
- would generate via: `mix ash.gen.resource Xaas.Operations.CastleVerbFortune5Requirements --ignore-if-exists --default-actions read`
