...
- module: `ApprovalPatchSlaCreditApply`
- domain: `Xaas.Billing`
- would generate via: `mix ash.gen.resource Xaas.Billing.ApprovalPatchSlaCreditApply --ignore-if-exists --default-actions read`
