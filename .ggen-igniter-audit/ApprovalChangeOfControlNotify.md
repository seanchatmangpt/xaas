...
- module: `ApprovalChangeOfControlNotify`
- domain: `Xaas.Governance`
- would generate via: `mix ash.gen.resource Xaas.Governance.ApprovalChangeOfControlNotify --ignore-if-exists --default-actions read`
