# Xaas.Platform.RouteOrgsCustomDomain
...
- module: `RouteOrgsCustomDomain`
- domain: `Xaas.Platform`
- would generate via: `mix ash.gen.resource Xaas.Platform.RouteOrgsCustomDomain --ignore-if-exists --default-actions read`
