...
- module: `ApprovalBreakGlassJustificationReview`
- domain: `Xaas.Governance`
- would generate via: `mix ash.gen.resource Xaas.Governance.ApprovalBreakGlassJustificationReview --ignore-if-exists --default-actions read`
