# Xaas.Governance.ApprovalDrFailover
...
- module: `ApprovalDrFailover`
- domain: `Xaas.Governance`
- would generate via: `mix ash.gen.resource Xaas.Governance.ApprovalDrFailover --ignore-if-exists --default-actions read`
