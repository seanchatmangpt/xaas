...
- module: `ApprovalVendorOffboardingAttestationIssue`
- domain: `Xaas.Governance`
- would generate via: `mix ash.gen.resource Xaas.Governance.ApprovalVendorOffboardingAttestationIssue --ignore-if-exists --default-actions read`
