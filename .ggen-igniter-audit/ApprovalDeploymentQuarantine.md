...
- module: `ApprovalDeploymentQuarantine`
- domain: `Xaas.Governance`
- would generate via: `mix ash.gen.resource Xaas.Governance.ApprovalDeploymentQuarantine --ignore-if-exists --default-actions read`
