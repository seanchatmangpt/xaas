...
- module: `ApprovalCastleVerbSchedule`
- domain: `Xaas.Operations`
- would generate via: `mix ash.gen.resource Xaas.Operations.ApprovalCastleVerbSchedule --ignore-if-exists --default-actions read`
