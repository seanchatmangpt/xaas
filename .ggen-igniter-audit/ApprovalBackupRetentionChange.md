...
- module: `ApprovalBackupRetentionChange`
- domain: `Xaas.Governance`
- would generate via: `mix ash.gen.resource Xaas.Governance.ApprovalBackupRetentionChange --ignore-if-exists --default-actions read`
