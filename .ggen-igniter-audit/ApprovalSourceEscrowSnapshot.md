...
- module: `ApprovalSourceEscrowSnapshot`
- domain: `Xaas.Governance`
- would generate via: `mix ash.gen.resource Xaas.Governance.ApprovalSourceEscrowSnapshot --ignore-if-exists --default-actions read`
