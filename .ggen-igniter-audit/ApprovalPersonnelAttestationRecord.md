...
- module: `ApprovalPersonnelAttestationRecord`
- domain: `Xaas.Governance`
- would generate via: `mix ash.gen.resource Xaas.Governance.ApprovalPersonnelAttestationRecord --ignore-if-exists --default-actions read`
