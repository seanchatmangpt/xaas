...
- module: `ApprovalEnvironmentPromote`
- domain: `Xaas.Governance`
- would generate via: `mix ash.gen.resource Xaas.Governance.ApprovalEnvironmentPromote --ignore-if-exists --default-actions read`
