...
- module: `CastleVerbInventoryComponents`
- domain: `Xaas.Operations`
- would generate via: `mix ash.gen.resource Xaas.Operations.CastleVerbInventoryComponents --ignore-if-exists --default-actions read`
