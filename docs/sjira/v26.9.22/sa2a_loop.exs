# SA2A driver for the v26.9.22 Semantic Jira loop. Usage (from ~/xaas, autofde on PATH):
#   PATH=$HOME/autofde-lab/.venv/bin:$PATH mix run --no-start docs/sjira/v26.9.22/sa2a_loop.exs plan
#   ... admit <identity> <work_order_digest>
...
case System.argv() do
  ["plan"] ->
    ...
    {:ok, resp} = Bridge.plan(cands, plan_id: "sjira-v26.9.22", ticks: 5000, tokens: 500_000, experiments: 20)
