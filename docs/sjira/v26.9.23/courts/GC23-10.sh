#!/bin/sh
# GC23-10 court: Cold Replay (PRD section 12; goal.ttl v23:GC23-10).
...
# Initial body (lane V23-P): the gate's machinery lands in lane V23-R, which
# replaces this body with the real court.
echo "UNKNOWN: GC23-10 machinery lands in lane V23-R"
exit 75
