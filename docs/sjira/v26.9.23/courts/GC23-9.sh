#!/bin/sh
# GC23-9 court: MachineExperience (PRD section 12; goal.ttl v23:GC23-9).
...
# Initial body (lane V23-P): the gate's machinery lands in lane V23-M, which
# replaces this body with the real court.
echo "UNKNOWN: GC23-9 machinery lands in lane V23-M"
exit 75
