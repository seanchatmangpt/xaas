#!/bin/sh
# GC23-12 court: Semantic Self-Hosting (PRD section 12; goal.ttl v23:GC23-12).
...
# Initial body (lane V23-P): the gate's machinery lands in lane V23-H, which
# replaces this body with the real court.
echo "UNKNOWN: GC23-12 machinery lands in lane V23-H"
exit 75
